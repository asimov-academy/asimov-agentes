...
- **Agente no WhatsApp, sem Chatwoot**: pareie um número lendo o QR code no próprio terminal. O WhatsApp roda num contêiner na sua VPS, que só sobe quando você cria o primeiro agente assim.
