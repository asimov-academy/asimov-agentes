...
api() {
  case "$1 $2" in
    ...
    "GET /admin/ferramentas") API_STATUS=200; API_RESPOSTA='[{"nome":"calculadora","rotulo":"Calculadora","descricao":"contas exatas","padrao":true},{"nome":"busca_web","rotulo":"Busca na web","descricao":"pesquisa na internet","padrao":true}]' ;;
...
# Menu: editar buffer, ferramentas e modelo do resumo, remover agente e empresa, consumo, esquecer token, sair.
menu_operador
