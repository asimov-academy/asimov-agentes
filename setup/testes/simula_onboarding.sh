...
api() {
  case "$1 $2" in
    ...
    "DELETE /admin/clientes/c1/agentes/a1") API_STATUS=200; API_RESPOSTA='{"removido":true,"canal_desconectado":false}' ;;
...
# Menu: editar buffer e modelo do resumo, remover agente e empresa, consumo, sair.
menu_operador
