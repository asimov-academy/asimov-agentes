...
api() {
  case "$1 $2" in
    ...
    "GET /admin/agentes") API_STATUS=200; API_RESPOSTA='[{"id":"a4","cliente_id":"c1","nome":"Carlos","canal":"waha","ativo":true},{"id":"a1","cliente_id":"c1","nome":"Luiz","canal":"chatwoot","ativo":true,"url_webhook":"https://bot.exemplo.com.br/webhook/chatwoot/tok1","buffer_segundos":8,"max_mensagens_por_resposta":3,"modelo_conversa":"openai:gpt-5.5","modelo_fallback":null,"modelo_auxiliar":"openai:gpt-5.5","modelo_visao":"openai:gpt-5-mini","modelo_transcricao":"openai:whisper-1","handoff_destino":null,"digitacao_caracteres_por_segundo":6,"digitacao_maximo_segundos":20,"ferramentas":["calculadora","busca_web"],"emojis":"livre","credenciais":{"url":"https://chatwoot.exemplo.com.br","account_id":4}},{"id":"a2","cliente_id":"c2","nome":"Bia","canal":"chatwoot","ativo":true,"url_webhook":"https://bot.exemplo.com.br/webhook/chatwoot/tok2","modelo_conversa":"groq:llama-3.3-70b-versatile","handoff_destino":{"tipo":"time","id":2,"nome":"Vendas"},"credenciais":{"url":"https://chatwoot.exemplo.com.br","account_id":3}}]' ;;
    ...
    "PATCH /admin/clientes/c1/agentes/a5") API_STATUS=200; API_RESPOSTA=$(jq -c --argjson m "$3" '. + $m' <<<'{"id":"a5","cliente_id":"c1","nome":"Sofia","canal":"whatsapp","ativo":true,"contatos_permitidos":[],"retomada_automatica_horas":4,"handoff_destino":null,"url_privacidade":"https://bot.exemplo.com.br/privacidade/loja-exemplo/sofia"}'); echo "$3" >"$DIR/patch_whatsapp" ;;
...
AGENTE='{"id":"a5","cliente_id":"c1","nome":"Sofia","canal":"whatsapp","ativo":true,"contatos_permitidos":[],"retomada_automatica_horas":4,"handoff_destino":{"tipo":"numero","telefone":"5511977776666","template":{"nome":"aviso_handoff","idioma":"pt_BR"}},"url_privacidade":"https://bot.exemplo.com.br/privacidade/loja-exemplo/sofia"}'
