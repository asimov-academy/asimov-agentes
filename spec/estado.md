...
| 10. Humanização dos agentes | **Etapas 1 e 2 construídas** (2026-09-18): ritmo com nome (migração `0022`), pausa de leitura antes do digitando, regras de conversa e de empatia em todo turno e o campo "o que ele nunca deve dizer". Faltam as etapas 3 a 5 e a validação em VPS. Plano em [docs/plano-humanizacao.md](../docs/plano-humanizacao.md), fase em spec/fases.md. Decidida em 2026-09-18: uma fase, depois da fase 6; aviso de IA nasce desligado, memória do contato nasce ligada |
