...
- `v0.5.3` em `asimov-academy/asimov-agentes` (público). Escolhas com setas e telas limpas desde a v0.5.1; Esc volta à tela anterior desde a v0.5.2. `main` tem também o README.
