...
| 10. Humanização dos agentes | **Etapas 1 a 4 construídas** (2026-09-18): ritmo com nome (migração `0022`), pausa de leitura antes do digitando, regras de conversa e de empatia em todo turno, o campo "o que ele nunca deve dizer" e a memória do contato (migração `0023`: resumo rolante da conversa e ficha de fatos, entrando no turno marcados como dado). Mais sentimento no turno, transferência por frustração e o aviso de que é uma IA (migração `0024`). Falta a etapa 5 e a validação em VPS. Plano em [docs/plano-humanizacao.md](../docs/plano-humanizacao.md), fase em spec/fases.md. Decidida em 2026-09-18: uma fase, depois da fase 6; aviso de IA nasce desligado, memória do contato nasce ligada |
