...
- `v0.20.3` em `asimov-academy/asimov-agentes` (público): contraste do texto do painel na régua da WCAG AA. `dim` e `muted` davam 1,9:1 e 2,4:1 sobre o preto, e rótulo, placeholder e texto de apoio sumiam; foram para 5,5:1 e 7,5:1, com um teste que trava o piso.
