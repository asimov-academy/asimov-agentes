...
- `v0.23.1` em `asimov-academy/asimov-agentes` (público): cartão de canal mais visual e com menos texto (logo num quadrado, uma frase curta e o aviso como ícone que abre no hover, pelo `Dica`), os dois WhatsApp com o nome técnico ("WhatsApp Cloud API" e "WhatsApp WAHA") e o logo do Chatwoot na forma da marca.
