...
- WhatsApp pela WAHA (`setup/lib/waha.sh`, v0.9.0): o contêiner sobe na primeira vez que o operador escolhe o canal (`garante_waha`), o QR code é desenhado com `qrencode` até o número parear e o destino do handoff é escolhido depois (número digitado ou grupo do próprio número).
...
- **Parte 2 (WAHA) ainda não rodou numa VPS**: falta parear um número de verdade, conferir texto, áudio e imagem, o aviso de handoff e o `/retomar`, e a remoção tirando o aparelho da lista do WhatsApp. O que o operador precisa: um chip de teste que possa ser bloqueado e o número ou grupo que recebe o handoff.
