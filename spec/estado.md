...
- `v0.21.2` em `asimov-academy/asimov-agentes` (público): tela **Configurações** (conta, instalação e as chaves de IA, que só existiam dentro da ficha de um agente), os três números da Visão geral viraram cartões de indicador no formato comum de painel, o recolher subiu para o topo do menu e o rodapé virou a área da conta, com avatar e endereço. O vazio da conversa deixou de ser um tracejado dentro de um cartão.
