...
- `v0.20.1` em `asimov-academy/asimov-agentes` (público): a tela do DNS do `bot` abre com a mesma frase da oferta do painel (o subdomínio inteiro e o IP da VPS), antes da tabela do registro.
